...
/**
 * Script para simular um webhook da XGate para um usuário específico
 */
...
if (!depositId) {
  ...
  console.error("Uso: npx ts-node scripts/simulate-webhook-for-user.ts ID_DO_DEPOSITO [ID_DO_USUARIO]")
  process.exit(1)
}

// Executar a simulação
console.log("=== SIMULAÇÃO DE WEBHOOK PARA USUÁRIO ESPECÍFICO ===")
