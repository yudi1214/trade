...
/**
 * Script simplificado para criar um depósito PIX na XGate
...
// Executar o teste
console.log("=== CRIAÇÃO DE DEPÓSITO PIX XGATE (SIMPLIFICADO) ===")
...
createXGateDeposit()
  .then((result) => {
    ...
    if (result) {
      ...
      console.log("\nPara salvar no Supabase, primeiro execute:")
      console.log("npx ts-node scripts/check-supabase-tables.ts")
